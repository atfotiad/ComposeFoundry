...
import com.atfotiad.composefoundry.sample.feature.counter.api.CounterApi
...
class CounterRepository @Inject constructor(
    ...
    /**
     * 1. ⚡ Reactive Stream: The UI observes this.
    ...
    /**
     * 2. 🌍 Network Sync: Fetches from API and updates DB.
